...
public class PLangDisjunctionGoalImpl extends PLangGoalImpl implements PLangDisjunctionGoal {

  public PLangDisjunctionGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PLangVisitor visitor) {
    visitor.visitDisjunctionGoal(this);
  }
